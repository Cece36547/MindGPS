...
import { Flame, RotateCcw, Trash2, Wind } from "lucide-react"
...
} // what is animate prescence? (Andy) AnimatePresence is a component from the Framer Motion library that allows us to animate components as they enter and exit the React tree. In this burn book component, 
// we use AnimatePresence to smoothly transition between the writing area and the success state 
// when the user releases their frustrations. It helps create a more engaging and dynamic user experience by animating the changes in the UI.
